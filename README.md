...
**Objetivo:** Contruir um museu digital usando apenas HTML5 e CSS3 e JavaScript.
**Tema:** Museu Digital.

### Alunos

- Enzo Ricardo (Ajudou no design e na estruturação)
- Filipe Andrade (Ajudou no código e nas imagens)
- Iago Nóbrega (Ajudou nas ideias e nas imagens)
- Marco Antônio (Ajudou no código e na organização)
